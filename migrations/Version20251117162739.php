 ...
 */
final class Version20251117162739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compte_client (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, numero_siren VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, devise VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_1DDD5D62A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
